...
if M < 0.3 and G < 0.1 and R < 0.9:
    A = 1.6
elif M < 0.3 and G < 0.1 and R < 0.95:
    A = 1.7
elif M < 0.3 and G < 0.1 and R >= 0.95:
    A = 1.8

elif M < 0.3 and G < 0.35 and R < 0.9:
    A = 1.9
elif M < 0.3 and G < 0.35 and R < 0.95:
    A = 2.0
elif M < 0.3 and G < 0.35 and R >= 0.95:
    A = 2.1
...
elif M < 0.6 and G < 0.1 and R < 0.9:
    A = 2.0
elif M < 0.6 and G < 0.1 and R < 0.95:
    A = 2.21
elif M < 0.6 and G < 0.1 and R >= 0.95:
    A = 2.42

elif M < 0.6 and G < 0.35 and R < 0.9:
    A = 2.63
elif M < 0.6 and G < 0.35 and R < 0.95:
    A = 2.84
elif M < 0.6 and G < 0.35 and R >= 0.95:
    A = 3.05
